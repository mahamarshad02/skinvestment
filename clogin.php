...
<body>
    ...
    <div class="myadminform">
        ...
        <div class="formcontent">
            <h1 style="text-align:center; margin-top:55px;">CUSTOMER LOG IN</h1>
            <form id="adminloginform" action="Clogin.php" method="post">
                ...
                <p style="margin: 10px;">Don't have an account? <a href="csignup.php">Signup</a></p>
                <p style="margin: 10px;"><a href="test2.php">Click here </a> to return to home page.</p>
            </form>
