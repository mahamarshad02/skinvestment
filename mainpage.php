        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="clogin.php">SHOP</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="login.php" onMouseOver="this.style.color='white'" onMouseOut="this.style.color='gray'" style="color: gray;" class="dropdown-item">ADMIN</a></li>
                        <li><a href="clogin.php" onMouseOver="this.style.color='white'" onMouseOut="this.style.color='gray'" style="color: gray;" class="dropdown-item">CUSTOMER</a></li>
                    </ul>
                    </li>
                </ul>
                </div>
